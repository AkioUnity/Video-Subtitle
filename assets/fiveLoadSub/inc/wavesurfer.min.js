...
WaveSurfer.create = function (a) {
    ...
    init: function (a, b) {
        ...
        var c = this.wrapper.scrollLeft, d = ~~(this.wrapper.clientWidth / 2), e = a - d, f = e - c,
    ...
    createElements: function () {
        ...
        var d = .5 / this.params.pixelRatio, e = this.width, f = this.params.height * this.params.pixelRatio,
            g = f * b || 0, h = f / 2, i = ~~(a.length / 2), j = this.params.barWidth * this.params.pixelRatio,
            k = Math.max(this.params.pixelRatio, ~~(j / 2)), l = j + k, m = 1;
        ...
        var d = .5 / this.params.pixelRatio, e = this.params.height * this.params.pixelRatio, f = e * b || 0, g = e / 2,
            h = ~~(a.length / 2), i = 1;
